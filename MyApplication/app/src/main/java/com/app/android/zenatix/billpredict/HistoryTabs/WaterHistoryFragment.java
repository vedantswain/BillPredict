...
//        }
    ...
    public void updateOnBackend(long rowId,float meterReading){
        ...
        (new UpdateTask(cno_water,TYPE,getMeterReading(rowId),meterReading,this)).execute();
    }
    ...
    public void updateCycleOnBackend(long rowId,float meterReading){
        ...
        (new UpdateCycleTask(cno_water,TYPE,getMeterReading(rowId),meterReading,this)).execute();
    }
    ...
    public void deleteOnBackend(long rowId){
        ...
        (new DeleteTask(cno_water,TYPE,getMeterReading(rowId),this)).execute();
    }

    public float getMeterReading(long rowId){
        SQLiteDatabase db = mDbHelper.getReadableDatabase();
        String[] projection = {
                DatabaseContract.WaterEntry.METER_READING,
        };
        ...
        c.moveToFirst();
        return c.getFloat(c.getColumnIndexOrThrow(DatabaseContract.WaterEntry.METER_READING));
    }

    public boolean isCycleID(long rowId){
        SQLiteDatabase db = mDbHelper.getReadableDatabase();
        String[] projection = {
                DatabaseContract.WaterEntry.CYCLE_START_ID,
        };
        String selection = DatabaseContract.WaterEntry._ID+"=?";
        String[] selectionArgs = {
                String.valueOf(rowId),
