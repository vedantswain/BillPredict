package in.ac.iiitd.zenatix.billpredict.AverageTabs;
 ...
 * Use the {@link WaterAverageFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WaterAverageFragment extends Fragment {
     ...
     * @return A new instance of fragment WaterAverageFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WaterAverageFragment newInstance(String param1, String param2) {
        WaterAverageFragment fragment = new WaterAverageFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_water_average, container, false);
        context=getActivity();
        setupRenderer();
        getCycleEntries();
        drawChart(mSeries);
    ...
    public void addToSeries(long cycleStartID,float cycleStartReading,String cycleStartDate) {
        ...
        Log.v(TAG,"Looking for readings with ID: "+cycleStartID);
        SQLiteDatabase db = mDbHelper.getWritableDatabase();
        String query = "SELECT * FROM " + DatabaseContract.WaterEntry.TABLE_NAME
                +" WHERE "+DatabaseContract.WaterEntry.CYCLE_START_ID+"="+cycleStartID
                +" ORDER BY "+DatabaseContract.WaterEntry.READING_DATE+" ASC";
        ...
        if (cursor != null && cursor.moveToFirst()) {
            while (cursor.isAfterLast() == false) {
                ...
                Log.v(TAG,"Reading entry: "+id+", "+reading+", "+date+", "
                        +cursor.getLong(cursor.getColumnIndex(DatabaseContract.WaterEntry.CYCLE_START_ID)));
    ...
    public void getCycleEntries(){
        ...
        SQLiteDatabase db = mDbHelper.getWritableDatabase();
        String query = "SELECT * FROM " + DatabaseContract.WaterEntry.TABLE_NAME
                +" WHERE "+DatabaseContract.WaterEntry.CYCLE_START_ID+"="+Integer.toString(-1)
                +" ORDER BY "+DatabaseContract.WaterEntry.READING_DATE+" ASC";
    ...
    public static void drawChart(TimeSeries mSeries){
        ...
        final GraphicalView chartView = ChartFactory.getTimeChartView(context, dataset, mRenderer, "Water Daily Average");
